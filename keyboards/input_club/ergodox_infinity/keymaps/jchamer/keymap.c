...
[_COLEMAKDH] = LAYOUT_ergodox(
 ...
 _______,    KC_Z,    KC_X,    KC_C,                KC_D,  LT(_MODS, KC_V), _______,
 ...
 // right hand
                ...
                _______,       KC_J,                KC_L,     KC_U,    KC_Y, LT(_MODS, KC_SCLN), _______,
                   KC_M,     HOME_N,              HOME_E,   HOME_I,  HOME_O,            _______,
                _______,       KC_K,                KC_H,  KC_COMM,  KC_DOT,            KC_SLSH, _______,
                                     LT(_NUMROW, KC_DEL),  _______, _______,            _______, _______,

             _______,           _______,
             _______,
 LT(_NUMROW, KC_DEL), LT(_MVMT, KC_ENT), KC_BSPC
),
...
[_MVMT] = LAYOUT_ergodox(
 ...
 // right hand
   ...
   _______, KC_DOWN,KC_RIGHT, KC_PGUP, KC_LBRC, KC_RBRC, _______,
            KC_MINS, KC_HOME,  KC_END,  KC_TAB,KC_QUOTE, _______,
...
[_NUMPAD] = LAYOUT_ergodox(
 ...
 _______, _______, _______, _______, _______,
  ...
  // right hank
  _______, _______, _______, _______, _______, _______, _______,
  _______, KC_COMM,   KC_P7,   KC_P8,   KC_P9, KC_PENT,  KC_NUM,
